# Frank 07/06/18:
# wrapping code into a function that can be fed
# other changes:
...
library(stringr) # for many string manipulations
...
knitPlates <- function(dataFile, descriptionFile, outTextFile, 
                              outPlotFile="tempOUT_PLOT.pdf", userOD=0.25,
  ...
  sheet_name <- 1 
  # set to name or number (defaults to sheet 1)
